...
app.get('*', async (req, res, next) => {
  try {
    ...
    const asyncScriptTags = extractor.getScriptElements();
    // You can also collect your "preload/prefetch" links
    const asyncLinkTags = extractor.getLinkElements();
    ...
    if (asyncScriptTags) data.asyncScripts = Array.from(asyncScriptTags);
    if (asyncLinkTags) data.asyncScripts = Array.from(asyncLinkTags);
